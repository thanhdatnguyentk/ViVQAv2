...
from .encoders import PhrasalEncoder # Explicit import to ensure registration? Or rely on __init__
...
class PhrasalMCAN(BaseClassificationModel):
    def __init__(self, config, vocab):
        ...
        # Use the specific PhrasalEncoder
        self.self_encoder = PhrasalEncoder(config.SELF_ENCODER)
        
        # Standard Guided Encoder for Cross-Modal (as per instructions)
